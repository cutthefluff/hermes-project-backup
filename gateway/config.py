...
class GatewayConfig:
    ...
    stt_review_before_processing: bool = False  # If true, transcribe voice and send a draft back without invoking the agent
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "stt_review_before_processing": self.stt_review_before_processing,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        stt_review_before_processing = data.get("stt_review_before_processing")
        if stt_review_before_processing is None:
            stt_review_before_processing = data.get("stt", {}).get("review_before_processing") if isinstance(data.get("stt"), dict) else None
        ...
        return cls(
            ...
            stt_review_before_processing=_coerce_bool(stt_review_before_processing, False),
